        ...
        <div class="d-flex dashboard-body">
            <div class="sidebar" style="position: fixed; z-index: 2;">
                ...
                <nav class="nav flex-column">
                    <router-link :to="`/doctor/${userId}/dashboard`" class="nav-link" exact-active-class="active-link">
                        <i class="bi bi-grid me-2"></i> Dashboard
                    </router-link>
                    <router-link :to="`/doctor/${userId}/dashboard/patient`" class="nav-link"
                        active-class="active-link">
                        <i class="bi bi-people-fill me-2"></i> Patient
                    </router-link>
                    <router-link :to="`/doctor/${userId}/dashboard/appointment`" class="nav-link"
                        active-class="active-link">
                        <i class="bi bi-calendar-check me-2"></i> Appointment
                    </router-link>
                    <router-link :to="`/doctor/${userId}/dashboard/treatment`" class="nav-link"
                        active-class="active-link">
                        <i class="bi bi-file-medical me-2"></i> Treatment History
                    </router-link>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item text-danger" href="" @click.prevent="logoutUser">Logout</a></li>
                            </ul>
                        </div>
